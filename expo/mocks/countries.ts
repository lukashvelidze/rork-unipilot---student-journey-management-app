...
export const countries: Country[] = [
  ...
  { code: "US", name: "United States", flag: "🇺🇸", isPopularDestination: true },
  { code: "UK", name: "United Kingdom", flag: "🇬🇧", isPopularDestination: true },
  { code: "CA", name: "Canada", flag: "🇨🇦", isPopularDestination: true },
  { code: "AU", name: "Australia", flag: "🇦🇺", isPopularDestination: true },
  { code: "DE", name: "Germany", flag: "🇩🇪", isPopularDestination: true },
  { code: "NL", name: "Netherlands", flag: "🇳🇱", isPopularDestination: true },
  { code: "FR", name: "France", flag: "🇫🇷", isPopularDestination: true },
  { code: "SE", name: "Sweden", flag: "🇸🇪", isPopularDestination: true },
...
export const getPopularDestinations = (): Country[] => {
  return countries.filter(country => country.isPopularDestination);
};
