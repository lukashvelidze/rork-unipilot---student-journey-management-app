...
with_node \
  ...
  --target "/Users/lukashvelidze/Desktop/UniPilot/rork-unipilot---student-journey-management-app/ios/Pods/Target Support Files/Pods-UniPilot/ExpoModulesProvider.swift" \
  --entitlement "/Users/lukashvelidze/Desktop/UniPilot/rork-unipilot---student-journey-management-app/ios/UniPilot/UniPilot.entitlements" \
   \
  --platform "apple" \
  --packages "@livekit/react-native-expo-plugin" "expo" "expo-asset" "expo-av" "expo-blur" "expo-constants" "expo-file-system" "expo-font" "expo-haptics" "expo-image" "expo-image-picker" "expo-keep-awake" "expo-linear-gradient" "expo-linking" "expo-location" "expo-router" "expo-splash-screen" "expo-store-review" "expo-symbols" "expo-system-ui" "expo-web-browser"
